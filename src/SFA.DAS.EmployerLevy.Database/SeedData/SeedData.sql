...
BEGIN
	...
	EXEC [CreateDeclaration] @levyAmount, @payeScheme, @submissionDate, 123, 123, @levyAmount, ''17-18'', 1, @submissionDate, NULL, NULL, NULL, 0, 0 
END'

EXEC sp_executesql @sqlCommand

IF NOT EXISTS(SELECT 1 FROM [TopUpPercentage] WHERE datefrom='2015-01-01 00:00:00.000' and amount=0.1 )
BEGIN
	insert into [TopUpPercentage]
	(datefrom,amount)
	values
